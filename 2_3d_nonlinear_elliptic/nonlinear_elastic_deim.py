...
pod_galerkin_method.set_Nmax(20, DEIM=21)
pod_galerkin_method.set_tolerance(1e-8, DEIM=1e-4)

# 5. Perform the offline phase
pod_galerkin_method.initialize_training_set(50, DEIM=60)
...
pod_galerkin_method.initialize_testing_set(50, DEIM=60)
